...
public class ObterResultado_Model {
    ...
    private int somaValorSubidaEncostaTentativa;
    private int somaPesoSubidaEncostaTentativa;
    ...
    public int getSomaValorSubidaEncostaTentativa() {
        return somaValorSubidaEncostaTentativa;
    }

    public void setSomaValorSubidaEncostaTentativa(int somaValorSubidaEncostaTentativa) {
        this.somaValorSubidaEncostaTentativa = somaValorSubidaEncostaTentativa;
    }

    public int getSomaPesoSubidaEncostaTentativa() {
        return somaPesoSubidaEncostaTentativa;
    }
